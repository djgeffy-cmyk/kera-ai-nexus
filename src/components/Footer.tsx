...
const Footer = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 pointer-events-none">
      <div className="mx-auto w-fit max-w-[95vw] mb-1 px-3 py-1.5 rounded-full bg-background/70 backdrop-blur border border-border/60 pointer-events-auto flex items-center gap-3">
        <a
        ...
        <a
          ...
          className="shrink-0 inline-flex items-center gap-1 text-[10px] text-emerald-400 hover:text-emerald-300 font-medium whitespace-nowrap"
        >
