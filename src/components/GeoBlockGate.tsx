    ...
    return (
      <main className="fixed inset-0 z-[9999] overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-10 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-6xl text-glow mb-4 leading-tight">
            KERA
          </h1>
          ...
          <p className="text-sm text-white/60 max-w-md mb-8">
            ...
            {state.country && state.country !== "UNKNOWN" ? ` (${state.country})` : ""}. Para
            liberar o acesso da sua organização, fale com a equipe Space in Cloud®.
          </p>
